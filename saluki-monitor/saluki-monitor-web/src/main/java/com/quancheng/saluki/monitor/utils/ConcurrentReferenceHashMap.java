...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable {
    ...
    public static enum Option {
                               /**
                                * Indicates that referential-equality (== instead of .equals()) should be used when
                                * locating keys. This offers similar behavior to {@link java.util.IdentityHashMap}
                                */
    ...
    static final class HashEntry<K, V> {
        ...
        HashEntry(K key, int hash, HashEntry<K, V> next, V value, ReferenceType keyType, ReferenceType valueType,
    ...
    static final class Segment<K, V> extends ReentrantLock implements Serializable {
        ...
        Segment(int initialCapacity, float lf, ReferenceType keyType, ReferenceType valueType,
                boolean identityComparisons){
            loadFactor = lf;
    ...
    /**
     * Creates a new, empty map with the specified initial capacity, reference types and with default load factor (0.75)
