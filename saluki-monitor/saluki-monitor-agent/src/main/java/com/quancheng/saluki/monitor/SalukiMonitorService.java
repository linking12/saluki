...
public class SalukiMonitorService implements MonitorService {
    ...
    private void writeToDataBase(SalukiURL statistics) {
        ...
        try {
            ...
            invoke.setElapsed(Double.valueOf(statistics.getParameter(ELAPSED, 0)));
            invoke.setInput(Double.valueOf(statistics.getParameter(INPUT, 0)));
            invoke.setOutput(Double.valueOf(statistics.getParameter(OUTPUT, 0)));
