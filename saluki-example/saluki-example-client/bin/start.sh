...
JAVA_OPTS="${JAVA_OPTS} -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=60002 -Djava.rmi.server.hostname=192.168.2.14"
JAVA_OPTS="${JAVA_OPTS} -Dcom.sun.management.jmxremote.authenticate=false"
JAVA_OPTS="${JAVA_OPTS} -Dcom.sun.management.jmxremote.ssl=false"
java -agentlib:jdwp=transport=dt_socket,server=y,address=8003,suspend=n -Djava.security.egd=file:/dev/./urandom $JAVA_OPTS -jar ./app.jar