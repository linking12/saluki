...
public class GrpcRemoteComponent {
  ...
  private static final ApiClassCache remoteServiceCache = ApiClassCache.getInstance();
  ...
  public String callRemoteService(String serviceName, String group, String version,
      String methodName, String requestParam) throws Throwable {
    try {
  ...
  public String callRemoteService(String serviceName, String group, String version,
      String methodName, Map<String, String> requestParam) throws Throwable {
    try {
      assert (serviceName != null);
      assert (group != null);
      assert (version != null);
