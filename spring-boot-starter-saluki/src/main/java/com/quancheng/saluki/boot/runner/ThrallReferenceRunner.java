 ...
 */
public class ThrallReferenceRunner extends InstantiationAwareBeanPostProcessorAdapter {

    private static final Logger             logger                     = LoggerFactory.getLogger(ThrallReferenceRunner.class);
    ...
    public ThrallReferenceRunner(ThrallProperties thrallProperties){
        ...
        if (StringUtils.isNoneBlank(referenceDefinPath)) {
            InputStream in = ThrallReferenceRunner.class.getClassLoader().getResourceAsStream(referenceDefinPath);
