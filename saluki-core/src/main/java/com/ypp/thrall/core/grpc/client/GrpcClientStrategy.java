...
import com.ypp.thrall.core.grpc.client.internal.DefaultProxyClient;
import com.ypp.thrall.core.grpc.client.internal.GenericProxyClient;
import com.ypp.thrall.core.grpc.client.internal.GrpcStubClient;
import com.ypp.thrall.core.utils.ReflectUtils;
...
public class GrpcClientStrategy {
    ...
    private GrpcProtocolClient<Object> buildProtoClient(ThrallURL refUrl) {
        ...
        if (isGeneric) {
            ...
            return new GenericProxyClient<Object>(new ThrallClassLoader(), methodRetries, refUrl);
        } else {
            if (isGrpcStub) {
